...
let api_key = "AIzaSyBF1no2S0ffVvkqm4JJAUOD7iXJ4b4ctgY";
...
searchBtn.addEventListener('click', () => {
    ...
    let getdata = () => {
        fetch(`https://www.googleapis.com/youtube/v3/channels?part=statistics&id=${'UC0PTktRYpZXb6On0_zFKWIg'}&key=${api_key}`)
        .then(response => {
